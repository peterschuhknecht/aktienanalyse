...
| Events | event_date, event_time, ticker/scope, event_type, event_name, event_uid/dedupe_key, depot_weight (0-10), relevance, source, source_quality, status, action_after_event |
...
| Depot-Ampel | date, scope (Depot oder Tickername), fundamental (0-10), timing (0-10), action (0-10), gesamt (0-10), note |
