...
| Events | event_date, event_time, ticker/scope, event_type, event_name, event_uid/dedupe_key, importance, depot_impact, depot_impact_reason, relevance, source, source_quality, status, action_after_event |
