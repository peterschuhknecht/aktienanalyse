...
- [ ] `latest_quotes.csv`, `monitoring_status.csv` und `peer_benchmarks.csv` mit 5D/1M/3M-/52W-Feldern und frischen Fundamentals befuellen.
- [ ] Nach US Payrolls 2026-06-05 und Eurostat-Q1-Update Makro-/Rates-Overlay nachziehen, falls Werte nach dem aktuellen Lauf veroeffentlicht wurden.
